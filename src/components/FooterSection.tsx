...
const GITHUB_USERNAME = "ananddub";

const actions = [
   {
      href: "mailto:duanand6@gmail.com",
      icon: Mail,
      label: "duanand6@gmail.com",
...
const socialIcons = [
   { href: "https://github.com/ananddub", icon: Github, label: "GitHub" },
   {
      href: "https://linkedin.com/in/ananddub/",
      icon: Linkedin,
      label: "LinkedIn",
   ...
   return (
      <footer className="relative flex min-h-[80vh] flex-col justify-between overflow-hidden border-t border-border-primary pt-[8vw] md:pt-16">
         ...
         <Container className="flex items-end justify-between pt-[6vw] md:pt-10 font-mono text-[2.5vw] md:text-sm uppercase text-fg-secondary">
            <span>© {currentYear} Anand Dubey</span>
