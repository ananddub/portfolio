...
const socials = [
   { url: "https://github.com/ananddub", label: "Github", icon: Github },
   {
      url: "https://linkedin.com/in/ananddub/",
      label: "LinkedIn",
      icon: Linkedin,
   },
      ...
      <div className="relative h-screen w-full overflow-hidden bg-bg-primary">
         ...
         <Container className="relative z-10 flex h-full flex-col items-center justify-center">
            ...
            >
               ...
               >
                  <TextScramble text="ANAND DUBEY" delay={200} duration={900} />
               </motion.h1>
               ...
               >
                  ...
                  <span className="inline-block" style={{ color: accentColor }}>
                     <Typewriter text="MOBILE & SYSTEMS SOFTWARE ENGINEER" />
                  </span>
                  <span
               ...
               >
                  Software Engineer specializing in cross-platform mobile apps (React Native, Flutter)
                  and distributed backend systems in Go and Rust. Experienced in building 60 FPS mobile
                  experiences, real-time gRPC/UDP protocols, and shipping production platforms to the Google Play Store.
               </motion.p>
