...
export async function generateMetadata({
	...
	const url = `https://ananddub.dev/blog/${slug}`;
	...
	return {
		...
		keywords,
		authors: [{ name: blog.author, url: "https://ananddub.dev" }],
		creator: blog.author,
		publisher: "Anand Dubey",
		...
		openGraph: {
			...
			siteName: "Anand Dubey Engineering Blog",
		...
		"@graph": [
			{
				...
				isPartOf: { "@id": "https://ananddub.dev/blog#blog" },
			...
			},
			{
				...
				"@id": `${url}#breadcrumb`,
				itemListElement: [
					{ "@type": "ListItem", position: 1, name: "Home", item: "https://ananddub.dev" },
					{ "@type": "ListItem", position: 2, name: "Blog", item: "https://ananddub.dev/blog" },
